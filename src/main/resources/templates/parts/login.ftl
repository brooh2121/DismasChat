...
<form action="${path}" method="post" xmlns="http://www.w3.org/1999/html">
    ...
    <#if isRegisterForm>
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-5">
                <input type="email" name="email" value="<#if user??>${user.email}</#if>"
                       class="form-control ${(emailError??)?string('is-invalid','')}" placeholder="Some@mail.com"/>
                <#if emailError??>
                    <div class="invalid-feedback">
                    ${emailError}
                    </div>
        ...
        <div class="col-sm-5">
            <div class="g-recaptcha" data-sitekey="6LevbYMUAAAAAHKRXkg-pjz0REZvPiVINC6B4jYa"></div>
            <#if captchaError??>
