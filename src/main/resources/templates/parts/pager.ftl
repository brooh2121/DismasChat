...
<div class="container mt-3">
    ...
    <ul class="pagination col justify-content-center">
        <li class="page-item disabled">
            <a class="page-link" href="#" tabindex="-1" tabindex="-1">Страницы</a>
        </li>
        <#list body as p>
    ...
    <ul class="pagination col justify-content-center">
        <li class="page-item disabled">
            <a class="page-link" href="#" tabindex="-1" tabindex="-1">Элементов на странице</a>
        </li>
